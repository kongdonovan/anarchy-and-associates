...
exports.DiscordErrorCode = exports.DiscordError = void 0;
const base_error_1 = require("./base-error");
/**
 * Error specific to Discord API operations
 */
class DiscordError extends base_error_1.BaseError {
    constructor(message, errorCode = base_error_1.ErrorCode.SYS_SERVICE_UNAVAILABLE, context, discordCode, discordMessage, httpStatus) {
     ...
     */
    static fromDiscordJSError(error, context) {
        ...
        let errorCode = base_error_1.ErrorCode.SYS_SERVICE_UNAVAILABLE;
        // Map specific Discord errors to our error codes
        if (discordCode === 50013 || discordCode === 50001) {
            errorCode = base_error_1.ErrorCode.PERM_INSUFFICIENT_PERMISSIONS;
        }
        else if ([10003, 10004, 10008, 10009, 10011].includes(discordCode)) {
            errorCode = base_error_1.ErrorCode.NF_ENTITY_NOT_FOUND;
        }
        else if (discordCode === 50035) {
            errorCode = base_error_1.ErrorCode.VAL_INVALID_INPUT;
        }
        return new DiscordError(message, errorCode, context, discordCode, discordMessage, httpStatus);
    }
    /**
...
(function (DiscordErrorCode) {
    DiscordErrorCode["DISCORD_API_ERROR"] = "DISCORD_001";
    DiscordErrorCode["DISCORD_RATE_LIMITED"] = "DISCORD_002";
    DiscordErrorCode["DISCORD_PERMISSION_DENIED"] = "DISCORD_003";
    DiscordErrorCode["DISCORD_ENTITY_NOT_FOUND"] = "DISCORD_004";
    DiscordErrorCode["DISCORD_INVALID_INPUT"] = "DISCORD_005";
    DiscordErrorCode["DISCORD_SERVICE_UNAVAILABLE"] = "DISCORD_006";
})(DiscordErrorCode || (exports.DiscordErrorCode = DiscordErrorCode = {}));
//# sourceMappingURL=discord-error.js.map