import { Case, CaseStatus, CaseUpdateRequest } from '../../validation';
...
export declare class CaseService {
    ...
    constructor(caseRepository: CaseRepository, caseCounterRepository: CaseCounterRepository, guildConfigRepository: GuildConfigRepository, permissionService: PermissionService, validationService: UnifiedValidationService, discordClient?: Client | undefined);
    private initializeArchiveService;
    createCase(context: PermissionContext, request: unknown): Promise<Case>;
    assignLawyer(context: PermissionContext, request: unknown): Promise<Case>;
    ...
    closeCase(context: PermissionContext, request: unknown): Promise<Case>;
    ...
    updateCase(context: PermissionContext, caseId: string, request: CaseUpdateRequest): Promise<Case>;
