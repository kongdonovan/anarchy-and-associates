...
const transaction_error_handler_1 = require("../../infrastructure/unit-of-work/transaction-error-handler");
...
describe.skip('Transaction Isolation Tests', () => {
    ...
    let errorHandler;
    // Test repositories
    class TestStaffRepository extends base_mongo_repository_1.BaseMongoRepository {
        constructor() {
            super('staff');
        }
    }
    class TestCaseRepository extends base_mongo_repository_1.BaseMongoRepository {
        constructor() {
            super('cases');
        }
    }
    beforeAll(async () => {
        ...
        mongoClient = new mongodb_1.MongoClient('mongodb://localhost:27017');
        await mongoClient.connect();
        // Initialize services
        rollbackService = new rollback_service_1.RollbackService();
        unitOfWorkFactory = new mongo_unit_of_work_1.MongoUnitOfWorkFactory(mongoClient);
        errorHandler = new transaction_error_handler_1.TransactionErrorHandler(rollbackService);
    });
    afterAll(async () => {
    ...
    describe('Concurrent Transaction Tests', () => {
        it('should handle concurrent staff creation without conflicts', async () => {
            const createStaffConcurrently = async (userId, role) => {
        ...
        it('should detect and handle write conflicts', async () => {
            ...
            try {
                ...
                const updatePromise1 = staffRepo1.update(staffId.insertedId.toString(), { role: 'Junior Associate' });
                const updatePromise2 = staffRepo2.update(staffId.insertedId.toString(), { role: 'Senior Associate' });
                // Execute updates
        ...
        it('should handle transaction errors with retry logic', async () => {
            ...
            const operation = async () => {
                ...
                if (attemptCount < 3) {
                    ...
                    error.code = 112; // TransientTransactionError
...
//# sourceMappingURL=transaction-isolation.test.js.map