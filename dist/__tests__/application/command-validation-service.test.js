...
describe('CommandValidationService', () => {
        ...
        mockInteraction = {
            ...
            options: {
                ...
                data: [
                    ...
                    { name: 'role', value: staff_role_1.StaffRole.JUNIOR_ASSOCIATE },
                ],
            },
            guild: {
                id: 'guild123',
    ...
    describe('handleBypassConfirmation', () => {
        it('should confirm bypass when pending bypasses exist', async () => {
            ...
            const result = await commandValidationService.handleBypassConfirmation(mockButtonInteraction, 'user123');
        ...
        it('should fail bypass when no pending bypasses exist', async () => {
            ...
            expect(mockButtonInteraction.reply).toHaveBeenCalledWith(expect.objectContaining({
                ephemeral: true,
            }));
        });
    });
    describe('extractValidationContext', () => {
        it('should extract context from interaction correctly', async () => {
            const context = await commandValidationService.extractValidationContext(mockInteraction, mockPermissionContext);
...
//# sourceMappingURL=command-validation-service.test.js.map