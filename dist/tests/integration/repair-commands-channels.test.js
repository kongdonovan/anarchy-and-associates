...
const repair_commands_1 = require("../../presentation/commands/repair-commands");
...
describe('RepairCommands - Channel Cleanup Integration', () => {
    ...
    let database;
    beforeAll(async () => {
        database = mongo_client_1.MongoDbClient.getInstance();
    ...
    beforeEach(async () => {
        ...
        repairCommands = new repair_commands_1.RepairCommands();
        // Mock guild
        mockGuild = {
            id: 'test-guild-id',
            name: 'Test Guild',
        ...
        const guildConfigRepo = repairCommands.guildConfigRepository;
...
// Helper functions
function createMockInteraction(guild) {
    const member = {
        id: 'test-user-id',
        user: {
            id: 'test-user-id',
...
//# sourceMappingURL=repair-commands-channels.test.js.map