...
import { InformationChannelService, UpdateInformationChannelRequest } from '../../application/services/information-channel-service';
...
describe('InformationChannelService', () => {
  let service: InformationChannelService;
  let mockRepository: jest.Mocked<InformationChannelRepository>;
  ...
  const createMockInfoChannel = (overrides: Partial<InformationChannel> = {}): InformationChannel => ({
  ...
  beforeEach(() => {
    ...
    service = new InformationChannelService(mockRepository, mockDiscordClient);
  });

  describe('updateInformationChannel', () => {
    const request: UpdateInformationChannelRequest = {
      guildId: '123456789012345678',
      channelId: '234567890123456789',
    ...
    it('should create a new information channel when none exists', async () => {
      ...
      expect(mockRepository.upsertByChannelId).toHaveBeenCalledWith(
        '123456789012345678',
        '234567890123456789',
    ...
    it('should update existing information channel and message', async () => {
      const existingInfo: InformationChannel = createMockInfoChannel({
  ...
  describe('getInformationChannel', () => {
    it('should return information channel if it exists', async () => {
      const info: InformationChannel = createMockInfoChannel({
        content: 'Content',
        lastUpdatedBy: '345678901234567890'
      });
